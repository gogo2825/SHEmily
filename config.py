...
tf.app.flags.DEFINE_string("train_dir", "/home/sg/yellowid-flask/flaskapp/model", "학습한 신경망을 저장할 폴더")
...
tf.app.flags.DEFINE_integer("epoch", 10000, "총 학습 반복 횟수")

tf.app.flags.DEFINE_string("data_path", "/home/sg/yellowid-flask/flaskapp/data/chat.log", "대화 파일 위치")
tf.app.flags.DEFINE_string("voc_path", "/home/sg/yellowid-flask/flaskapp/data/chat.voc", "어휘 사전 파일 위치")
tf.app.flags.DEFINE_boolean("voc_test", True, "어휘 사전을 테스트합니다.")
